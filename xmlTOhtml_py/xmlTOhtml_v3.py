...
class xmlTOhtml:
    ...
    def __init__(self):
        ...
        self.defectlist = r"\\V01\dfs\DIDA6003\CT\CT Projects\Platform\IPU02\02_DQ\34_Software Verification  report\Daily build TestReport\Defect information"
##        self.lineALL=[]
    ...
    def html_Head(self):
       ...
       # print(fs)
        ...
        Test_Overview = '<h4>Test Overview</h4>'\
                   ...
                   + '</tr>' \
                   + '</table>'
        Defect_Information = '<h4>Defect Information</h4>'\
                   + '<table width = 860 border="1" style="border-collapse: collapse;cellspacing="0"">' \
                       + '<tr>' \
                       + '<td bgcolor="#20B2AA"><font color="#FFFFFF">Defect list</font></td>' \
                       + '<td style="font-family: Verdana"><a href="' + self.defectlist +'">'+ self.defectlist  + '</td>' \
                       + '</tr>' \
                             + '</table>'
        ...
        HeadData = '<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN"><html><body>' \
                   + '<h1>IPU02冒烟自动化测试报告</h1>'+ Test_Overview +Defect_Information+ Test_Information
